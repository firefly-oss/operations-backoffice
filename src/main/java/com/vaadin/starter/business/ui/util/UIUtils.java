...
public class UIUtils {
	...
	public static Span createLabel(FontSize size, TextColor color,
	                                String text) {
	...
	public static Span createLabel(FontSize size, String text) {
	...
	public static Span createH1Label(String text) {
		Span label = new Span(text);
		label.addClassName(LumoStyles.Heading.H1);
		return label;
	}

	public static Span createH2Label(String text) {
		Span label = new Span(text);
		label.addClassName(LumoStyles.Heading.H2);
		return label;
	}

	public static Span createH3Label(String text) {
		Span label = new Span(text);
		label.addClassName(LumoStyles.Heading.H3);
		return label;
	}

	public static Span createH4Label(String text) {
		Span label = new Span(text);
		label.addClassName(LumoStyles.Heading.H4);
		return label;
	}

	public static Span createH5Label(String text) {
		Span label = new Span(text);
		label.addClassName(LumoStyles.Heading.H5);
		return label;
	}

	public static Span createH6Label(String text) {
		Span label = new Span(text);
	...
	public static Span createAmountLabel(double amount) {
		Span label = createH5Label(formatAmount(amount));
	...
	public static Span createUnitsLabel(int units) {
		Span label = new Span(formatUnits(units));
		label.addClassName(LumoStyles.FontFamily.MONOSPACE);
		return label;
	}
